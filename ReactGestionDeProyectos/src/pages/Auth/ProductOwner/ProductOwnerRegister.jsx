...
import { funcion_product_owner_register } from "../../../services/authService"

function ProductOwnerRegister () {
    ...
    const submit = (e) => {
        e.preventDefault()
        funcion_product_owner_register({nombre: nombre, email: email, password: password, confirmed_password: confirmed_password})
            .then(res => {
                    if(res.data.errors){
        ...
        <div className={PantallaAzul}>
            <div className={`bg-white p-8 rounded-lg shadow-lg w-full max-w-md`}>
                ...
                <form onSubmit={submit} className="space-y-6 mt-4 max-w-md mx-auto rounded-lg p-3"   method="post">
                    <h1 className="text-2xl font-bold text-center text-blueDark mb-2">Register</h1>
                    ...
                    <label className="text-blueDark text-sm leading-none font-bold select-none peer-disabled:cursor">Name: </label>  
                    <input 
                    value={nombre}
                    ...
                    <label className="text-sm text-blueDark leading-none font-bold select-none peer-disabled:cursor">Email: </label>
                    <input 
                    value={email}
                    ...
                    <label className="text-blueDark text-sm leading-none font-bold select-none peer-disabled:cursor">Confirm Password: </label>
                    <input 
...
export default ProductOwnerRegister